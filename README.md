...
| 4/15/16 |  pulled the data through tweet data through twitter API and have pulled data for discussions on deadpool movie |sairaj,surya kiran,arunkumar | projected our prelimenary results of trending topics on twitter . |
